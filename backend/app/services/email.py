        ...
        <body style="font-family: 'Inter', sans-serif; background-color: #f6f9fc; padding: 40px 20px; margin: 0;">
            <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 16px; border: 1px solid #eef2f6; overflow: hidden; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.05);">
                ...
                <div style="padding: 40px 32px;">
                    <h3 style="color: #1a202c; margin: 0 0 16px 0; font-size: 20px; font-weight: 700;">Konfirmasi Pendaftaran Akun Anda</h3>
                    <p style="color: #4a5568; font-size: 14px; line-height: 24px; margin: 0 0 32px 0;">
                        Terima kasih telah mendaftar di platform AI Security Reports. Langkah terakhir untuk mengaktifkan akun Anda adalah dengan melakukan verifikasi email melalui tautan tombol di bawah ini:
                    </p>
                    ...
                    <p style="color: #718096; font-size: 12px; line-height: 20px; margin: 0 0 16px 0;">
                        Tautan ini hanya berlaku selama 24 jam. Jika tombol di atas tidak berfungsi, Anda juga dapat menyalin dan menempelkan tautan berikut ke browser Anda:
                    </p>
    ...
    <html>
        <body style="font-family: 'Inter', sans-serif; background-color: #f6f9fc; padding: 40px 20px; margin: 0;">
            <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 16px; border: 1px solid #eef2f6; overflow: hidden; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.05);">
                ...
                <!-- Body -->
                <div style="padding: 40px 32px;">
                    <h3 style="color: #1a202c; margin: 0 0 16px 0; font-size: 20px; font-weight: 700;">Permintaan Reset Kata Sandi</h3>
                    <p style="color: #4a5568; font-size: 14px; line-height: 24px; margin: 0 0 32px 0;">
                        Kami menerima permintaan untuk mereset kata sandi akun Anda. Jika Anda tidak melakukan permintaan ini, abaikan email ini. Jika Anda ingin melanjutkannya, silakan klik tombol di bawah ini:
                    </p>
                    <div style="text-align: center; margin-bottom: 32px;">
                        <a href="{link}" style="display: inline-block; padding: 14px 32px; background-color: #005c3a; color: #ffffff; font-weight: 700; font-size: 14px; text-decoration: none; border-radius: 8px; box-shadow: 0 4px 6px rgba(0, 92, 58, 0.15); transition: background-color 0.2s;">
                            Reset Kata Sandi
                    ...
                    <p style="color: #718096; font-size: 12px; line-height: 20px; margin: 0 0 16px 0;">
                        Tautan reset ini hanya berlaku selama 1 jam. Jika Anda tidak dapat mengeklik tombol di atas, silakan salin tautan berikut ke browser:
                    </p>
                    <p style="color: #005c3a; font-size: 12px; word-break: break-all; margin: 0;">
                        {link}
                    </p>
