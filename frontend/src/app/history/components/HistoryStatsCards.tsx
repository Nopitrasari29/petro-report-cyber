      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        ...
        <div className="bg-white border border-stone-200/80 rounded-2xl p-5 shadow-sm text-left flex flex-col justify-between premium-card-hover cursor-pointer">
          <div>
            ...
            <div className="text-2xl font-black text-stone-850 mt-3">
              {totalCount}
            </div>
          </div>
          <div className="text-[10px] text-stone-400 font-bold mt-2">
            {tx("All time", "All time")}
          </div>
        </div>
        ...
        <div className="bg-white border border-stone-200/80 rounded-2xl p-5 shadow-sm text-left flex flex-col justify-between premium-card-hover cursor-pointer">
          ...
          <div className="text-[10px] text-emerald-600 font-bold mt-2">
            {approvedPercent}% {tx("of total", "of total")}
          </div>
        </div>
        ...
        <div className="bg-white border border-stone-200/80 rounded-2xl p-5 shadow-sm text-left flex flex-col justify-between premium-card-hover cursor-pointer">
          ...
          <div className="text-[10px] text-sky-600 font-bold mt-2">
            {inReviewPercent}% {tx("of total", "of total")}
          </div>
        </div>
        ...
        <div className="bg-white border border-stone-200/80 rounded-2xl p-5 shadow-sm text-left flex flex-col justify-between premium-card-hover cursor-pointer">
          ...
          <div className="text-[10px] text-amber-600 font-bold mt-2">
            {draftPercent}% {tx("of total", "of total")}
          </div>
        </div>
        ...
        <div className="bg-white border border-stone-200/80 rounded-2xl p-5 shadow-sm text-left flex flex-col justify-between premium-card-hover cursor-pointer">
          ...
          <div className="text-[10px] text-purple-600 font-bold mt-2">
            {exportedPercent}% {tx("of total", "of total")}
          </div>
        </div>
      </div>
    </ScrollReveal>
