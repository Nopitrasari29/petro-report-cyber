            ...
            <tbody className="divide-y divide-stone-100 text-stone-700 text-xs font-bold">
              {currentRows.map((item, rowIdx) => {
                ...
                return (
                  ...
                  >
                    <td className="py-4 px-6 font-black text-stone-855 text-left group-hover:text-petro-green transition-colors duration-200">{item.title}</td>
                    ...
                    <td className="py-4 px-6 text-left">{item.created_by_name || t("Analyst")}</td>
              ...
              {Array.from({ length: totalPages }).map((_, i) => {
                ...
                return (
                  <button
                    ...
                    className={`w-8 h-8 rounded-lg flex items-center justify-center font-bold transition-all cursor-pointer ${currentPage === pageNum
