      ...
      <div className="flex flex-wrap items-center gap-3 flex-1 min-w-[280px]">
        ...
        <div className="relative">
          <select
            ...
            className="appearance-none pl-3 pr-8 py-2 border border-stone-200 rounded-xl text-xs font-bold text-stone-700 bg-white focus:outline-none focus:border-petro-green cursor-pointer transition-colors"
          >
            <option value="All Types">{tx("All Types", "All Types")}</option>
            <option value="SOC Report">{tx("SOC Report", "SOC Report")}</option>
            <option value="Threat Trend">
              {tx("Threat Trend", "Threat Trend")}
            </option>
            <option value="Threat Hunting">
              {tx("Threat Hunting", "Threat Hunting")}
            </option>
            <option value="IDS/IPS Report">
              {tx("IDS/IPS Report", "IDS/IPS Report")}
            </option>
          </select>
          <span className="absolute inset-y-0 right-0 pr-2.5 flex items-center pointer-events-none text-stone-500">
            <svg
        ...
        <div className="relative">
          <select
            ...
            className="appearance-none pl-3 pr-8 py-2 border border-stone-200 rounded-xl text-xs font-bold text-stone-700 bg-white focus:outline-none focus:border-petro-green cursor-pointer transition-colors"
          >
            <option value="All Users">{tx("All Users", "All Users")}</option>
            {creators.map((name) => (
