    ...
    <ScrollReveal animation="fadeInUp" delay={100}>
      <div className="bg-white border border-stone-200/80 rounded-2xl p-8 shadow-sm text-left premium-card-hover">
        <h3 className="font-extrabold text-stone-900 text-sm">
          {tx("Profile Information", "Profile Information")}
        </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mt-8 items-start">
          ...
          <div className="md:col-span-4 flex flex-col items-center py-4">
            <span className="text-xs font-bold text-stone-500 mb-3">
              {tx("Profile Picture", "Profile Picture")}
            </span>
          ...
          <div className="md:col-span-8 space-y-4">
            ...
            <div className="flex flex-col gap-1">
              <label className="text-xs font-bold text-stone-700 mb-1.5">
                {tx("Full Name", "Full Name")}
              </label>
              <input
                type="text"
                value={fullName}
                onChange={(e) => setFullName(e.target.value)}
                placeholder={tx("Enter your full name", "Enter your full name")}
            ...
            {passwordSet ? (
              <>
                ...
                <div className="flex flex-col gap-1 relative">
                  <label className="text-xs font-bold text-stone-700 mb-1.5">
                    {tx("Current Password", "Current Password")}
                  </label>
                  <input
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-xl p-3.5">
                ...
                <p className="text-[11px] text-blue-700 font-semibold mt-1">
                  {tx(
                    "You don't have a password yet. Set one below if you'd also like to sign in manually with your email, without going through Google.",
                    "You don't have a password yet. Set one below if you'd also like to sign in manually with your email, without going through Google.",
                  )}
                </p>
              </div>
            ...
            <div className="flex flex-col gap-1 relative">
              <label className="text-xs font-bold text-stone-700 mb-1.5">
                {tx("Confirm New Password", "Confirm New Password")}
              </label>
              <input
            ...
            <span className="text-[10px] text-stone-450 font-semibold mt-1">
              {tx(
