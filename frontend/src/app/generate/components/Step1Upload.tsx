            ...
            {files.length === 0 ? (
              ...
              <div>
                <div className="flex items-center justify-between border-b border-stone-100 pb-3 mb-4">
                  <h3 className="font-bold text-stone-855 text-sm">
                    {tx("Uploaded Files", "Uploaded Files")} ({files.length})
                  </h3>
                  <span className="text-[9px] text-stone-400 font-semibold">{tx("PDF, CSV, XLSX · Max 100MB/file", "PDF, CSV, XLSX · Max 100MB/file")}</span>
                </div>
                ...
                <div className="flex gap-4 overflow-x-auto pb-1 -mx-1 px-1">
                  ...
                  >
                    ...
                    <span className="text-[10px] font-bold">{tx("Add File", "Add File")}</span>
                    <input
                      type="file"
                      accept=".pdf,.csv,.xlsx,.xls"
                      multiple
