...
function ResetPasswordContent() {
  ...
  useEffect(() => {
    if (!token) {
      setError(
        tx(
          "Token reset kata sandi tidak ditemukan atau tidak valid.",
          "Token reset kata sandi tidak ditemukan atau tidak valid.",
        ),
      );
    }
        ...
        <div className="space-y-6 text-center py-6">
          ...
          <div className="space-y-2">
            <h3 className="text-2xl font-extrabold text-stone-900">
              {tx("Password Updated!", "Password Updated!")}
            </h3>
          ...
          <div className="pt-4 border-t border-stone-100 mt-6">
            ...
            >
              {tx("Sign in to Account", "Sign in to Account")}
            </Link>
          </div>
        </div>
      ) : (
        <div>
          ...
          <div className="text-center mb-8">
            <h2 className="text-2xl font-extrabold text-stone-900">
              {tx("Reset Password", "Reset Password")}
            </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            >
              {loading
                ? tx("Resetting password...", "Resetting password...")
                : tx("Update Password", "Update Password")}
            </button>
          </form>
        </div>
      )}
