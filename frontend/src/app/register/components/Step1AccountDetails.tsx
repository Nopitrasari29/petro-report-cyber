    ...
    <div className="w-full max-w-[560px] bg-white rounded-2xl shadow-sm border border-stone-200/80 p-10 sm:p-12">
      <div className="flex items-center justify-between mb-6">
        ...
        <span className="text-sm font-bold text-petro-green">
          {tx("Step 1 of 2", "Step 1 of 2")}
        </span>
      </div>

      <div className="mb-7">
        <h2 className="text-xl font-extrabold text-stone-900">
          {tx("Create Your Account", "Create Your Account")}
        </h2>
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder={tx("Confirm your password", "Confirm your password")}
              required
              autoComplete="new-password"
              className="w-full pl-10 pr-12 py-3 border border-stone-200 rounded-xl bg-stone-50 text-sm text-stone-800 placeholder-stone-400 focus:outline-none focus:ring-2 focus:ring-petro-green/20 focus:border-petro-green transition-all"
            />
      ...
      {/* Google Sign-Up: backend otomatis mendaftarkan akun baru kalau emailnya belum terdaftar,
          jadi tombol ini berfungsi sebagai "Sign up with Google" tanpa perlu isi form di atas. */}
      <GoogleSignInButton
